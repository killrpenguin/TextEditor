...
// configuration step. It creates a namespace called `TextEditor`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", TextEditor::cmake::project_name, TextEditor::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", TextEditor::cmake::project_version);
      return EXIT_SUCCESS;
    }
